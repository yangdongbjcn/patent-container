$(document).ready(function(){
	...
	new YdMenuActive().initMenu("last_search_brief");

	// 统计获取当前用户的最后一次搜索
    var p_url = g_var.g_server_patent_data + 'Search/api_last_search';
	p_data = {'user_id': g_var.u_eng_name};	//2018-6-6 cpy id=2
