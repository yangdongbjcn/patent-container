...
if __name__ == '__main__':
    ...
    input_device.addTreeData(u'C://YANGDONG//patent-container//patent_container_python//test')
    input_device.dump()
    ...
    frame = Frame()
    frame.table = YdbjSheet().loadSheet(u'C://YANGDONG//patent-container//patent_container_python//test//input.xls')
